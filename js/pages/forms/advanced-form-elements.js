$(function() {
    ...
    //Mobile Phone Number
    $demoMaskedInput.find('.mobile-phone-number').inputmask('0999.999.999', { placeholder: '___-__-__' });
    //Phone Number
    ...
    $demoMaskedInput.find('.number').inputmask({
      alias: "numeric",
      groupSeparator: ".",    // dấu phân cách hàng nghìn, có thể đổi thành "." nếu muốn
      autoGroup: true,        // tự động phân nhóm
      digits: 0,              // số chữ số thập phân, 0 nếu chỉ số nguyên
      digitsOptional: false,  // bắt buộc phải nhập đủ chữ số thập phân nếu > 0
      prefix: '',             // tiền tố, ví dụ "$" nếu muốn
      placeholder: '0',
      rightAlign: false       // căn trái
    });
